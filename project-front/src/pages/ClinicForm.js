        ...
        <form onSubmit={this.handleSubmit} className="FormField3">
          ...
          <div className="FormField3">
            <label className="clinicFormLable" htmlFor="info">
              توضیحات تکمیلی درمورد مطب خود را وارد کنید
            </label>
            <textarea
              type="text"
          ...
          <div className="FormField1">
            <button className="clinicButton">ثبت مطب</button>{" "}
          </div>
        </form>
        <Modal style={{ fontFamily: "BZar" }} isOpen={this.state.isnotLoged}>
          <ModalBody>
            ...
            <Button
              ...
              id="1"
              onClick={(e) => {
                this.setState({ isnotLoged: false });
          ...
          <ModalBody className="modalbodCalender">.مطب جدید ثبت شد</ModalBody>
        </Modal>
      </div>
    );
  }
