...
export default class ChatList extends Component {
  ...
  getItems(){
      ...
      fetch("http://localhost:8000/api/chatlist", {
        method: "GET",
        headers: {
              ...
              <div class="chat_list active_chat"   >
                <div class="chat_people">
                  ...
                  {postdetail.destpp !== null ? (
                    <img src={postdetail.destpp} className="chat_img" onClick={this.ChatListOnClick} name={postdetail.destid}/>
                  ) : (
                    <img src={avatar} className="chat_img" onClick={this.ChatListOnClick} name={postdetail.destid}/>
                  )}
                   <div class="chat_ib">
                 <h5>
